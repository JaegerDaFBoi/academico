...
<div class="block">
  ...
  <select class="form-select appearance-none
      ...
      ease-in-out
      m-0
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="materia">
...
<div class="block">
  ...
  <select class="form-select appearance-none
      ...
      ease-in-out
      m-0
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="estudiante">
